    ...
    return (
      <div>
          <header className="backgroundImage_1hK9M header_1OPY8 post_detail_header">
              <div className="constraintWidth_ZyYbM content_1Truy">
                  <main className="main_3Naik">
                      ...
                      <div className="info_F11MZ">
                          ...
                          <h2 className="tagline_1Y-13 text_3Wjo0 inverse_1CN6F base_3CbW2">Chat with a designer who
                              will help furnish your room</h2>
                                    ...
                                    <span
                                      className="secondaryBoldText_1PBCf secondaryText_PM80d default_tBeAo base_3CbW2">
                                        <span className="inactiveLink_C7GyP baseLink_8cU0P">
                                            <a target="_blank"
                                               href="https://www.producthunt.com/r/f79eeb2c5f95e3/68707">get it</a>
                                        </span>
                                        <span className="inactivePopoverToggle_1Nj6V basePopoverToggle_3wt0O"
                                              rel="Show more">
                                            <svg width="5" height="4" viewBox="0 0 5 4"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path d="M5,4 L0,4 L2.5,0 L5,4 Z" fill="#FFF"
                                                      transform="matrix(1 0 0 -1 0 4)" fill-rule="evenodd"></path>
                                            </svg>
                                        </span>
                                    </span>
                                </span>
              ...
              <div className="stickyHeader_p946x">
                  <div className="stickyHeaderContent_25OTL">
                        <span className="comboButton_1rStc tech_25H3R">
                            <span className="secondaryBoldText_1PBCf secondaryText_PM80d default_tBeAo base_3CbW2">
                                ...
                                <span className="inactivePopoverToggle_1Nj6V basePopoverToggle_3wt0O" rel="Show more">
                                    <svg width="5" height="4" viewBox="0 0 5 4" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M5,4 L0,4 L2.5,0 L5,4 Z" fill="#FFF" transform="matrix(1 0 0 -1 0 4)"
